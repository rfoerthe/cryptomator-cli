...
pub(crate) trait Reply: Send + 'static {
    ...
    ///
    /// `abi` selects the wire layout of the reply bodies that embed a `fuse_attr`; it comes from
    /// [`crate::Config::abi`] and is a no-op on every target but macOS.
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> Self;
}
...
pub(crate) struct ReplyRaw {
    ...
    /// Wire layout to encode reply bodies in
    abi: KernelAbi,
}

impl Reply for ReplyRaw {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyRaw {
        ReplyRaw {
            unique,
            sender: Some(sender),
            abi,
...
impl Reply for ReplyEmpty {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyEmpty {
        ReplyEmpty {
            reply: Reply::new(unique, sender, abi),
        }
    }
}
...
impl Reply for ReplyData {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyData {
        ReplyData {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl Reply for ReplyEntry {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyEntry {
        ReplyEntry {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl ReplyEntry {
    ...
    pub fn entry(self, ttl: &Duration, attr: &FileAttr, generation: Generation) {
        let abi = self.reply.abi;
        self.reply.send_ll(&ll::ResponseEntry::new_entry(
            attr.ino,
            generation,
            &attr.into(),
            *ttl,
...
impl Reply for ReplyAttr {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyAttr {
        ReplyAttr {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl ReplyAttr {
    ...
    pub fn attr(self, ttl: &Duration, attr: &FileAttr) {
        let abi = self.reply.abi;
        self.reply
            .send_ll(&ll::ResponseAttr::new_attr(ttl, &attr.into(), abi));
    }
...
impl Reply for ReplyXTimes {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyXTimes {
        ReplyXTimes {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl Reply for ReplyOpen {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyOpen {
        ReplyOpen {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl Reply for ReplyWrite {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyWrite {
        ReplyWrite {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl Reply for ReplyStatfs {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyStatfs {
        ReplyStatfs {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl Reply for ReplyCreate {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyCreate {
        ReplyCreate {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl ReplyCreate {
    ...
    pub fn created(
        ...
        assert!(!flags.contains(FopenFlags::FOPEN_PASSTHROUGH));
        let abi = self.reply.abi;
        self.reply.send_ll(&ll::ResponseCreate::new_create(
            ttl,
            &attr.into(),
            generation,
            fh,
...
impl Reply for ReplyLock {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyLock {
        ReplyLock {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl Reply for ReplyBmap {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyBmap {
        ReplyBmap {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl Reply for ReplyIoctl {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyIoctl {
        ReplyIoctl {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl Reply for ReplyPoll {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyPoll {
        ReplyPoll {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl Reply for ReplyXattr {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyXattr {
        ReplyXattr {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
impl Reply for ReplyLseek {
    fn new(unique: ll::RequestId, sender: ReplySender, abi: KernelAbi) -> ReplyLseek {
        ReplyLseek {
            reply: Reply::new(unique, sender, abi),
        }
    }
...
mod test {
    ...
    fn reply_raw() {
        ...
        let reply: ReplyRaw = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
    ...
    fn reply_empty() {
        ...
        let reply: ReplyEmpty = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
        reply.ok();
    }
    ...
    fn reply_data() {
        ...
        let reply: ReplyData = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
    ...
    fn reply_entry() {
        ...
        let reply: ReplyEntry = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
    ...
    fn reply_attr() {
        ...
        let sender = ReplySender::Assert(AssertSender { expected });
        let reply: ReplyAttr = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
        let time = UNIX_EPOCH + Duration::new(0x1234, 0x5678);
        let ttl = Duration::new(0x8765, 0x4321);
        let attr = FileAttr {
            ino: INodeNo(0x11),
    ...
    fn reply_xtimes() {
        ...
        let reply: ReplyXTimes = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
        let time = UNIX_EPOCH + Duration::new(0x1234, 0x5678);
    ...
    fn reply_open() {
        ...
        let reply: ReplyOpen = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
    ...
    fn reply_write() {
        ...
        let reply: ReplyWrite = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
    ...
    fn reply_statfs() {
        ...
        let reply: ReplyStatfs = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
    ...
    fn reply_create() {
        ...
        let sender = ReplySender::Assert(AssertSender { expected });
        let reply: ReplyCreate = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
        let time = UNIX_EPOCH + Duration::new(0x1234, 0x5678);
        let ttl = Duration::new(0x8765, 0x4321);
        let attr = FileAttr {
            ino: INodeNo(0x11),
    ...
    fn reply_lock() {
        ...
        let reply: ReplyLock = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
    ...
    fn reply_bmap() {
        ...
        let reply: ReplyBmap = Reply::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
        reply.bmap(0x1234);
    }
    ...
    fn reply_directory() {
        ...
        let mut reply =
            ReplyDirectory::new(ll::RequestId(0xdeadbeef), sender, 4096, KernelAbi::Native);
    ...
    fn reply_xattr_size() {
        ...
        let reply = ReplyXattr::new(ll::RequestId(0xdeadbeef), sender, KernelAbi::Native);
